 ...
 * mit @see print_errmsg() ausgegeben werden.
 *
...
/**
 * Verabeitet die Daten und gibt die Ergebnisseite aus.
...
function display() {
    ...
    /**
     * Hier wird HEREDOC-Syntax verwendet, um die HTML-Seite zu bilden
     */
    $page = <<<PAGE
        <!DOCTYPE html>
        <html lang="en">
